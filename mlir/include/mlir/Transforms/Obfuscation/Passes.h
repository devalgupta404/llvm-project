//===- Passes.h - MLIR obfuscation passes -----------------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This header declares the MLIR-level obfuscation passes: string encryption,
// symbol obfuscation, constant obfuscation, cryptographic symbol hashing,
// SCF opaque-predicate insertion, and import-table hiding.
//
//===----------------------------------------------------------------------===//

#ifndef MLIR_TRANSFORMS_OBFUSCATION_PASSES_H
#define MLIR_TRANSFORMS_OBFUSCATION_PASSES_H
...
struct StringEncryptPass
  ...
  StringRef getDescription() const override {
    return "Obfuscate LLVM string globals";
  }
...
#endif // MLIR_TRANSFORMS_OBFUSCATION_PASSES_H
